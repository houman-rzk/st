 ...
 */
const static int mousescrollincrement = 3;
...
//	{ TERMMOD,              XK_Page_Down,   zoom,           {.f = -1} },
	{ ControlMask,          XK_period,      zoomreset,      {.f =  0} },
...
//	{ TERMMOD,		        XK_V,           clippaste,      {.i =  0} },
	...
	{ ControlMask|ShiftMask,XK_I,           copyurl,        {.i =  0} },
	...
	{ LEFTALT,              XK_y,           externalpipe,   {.v = copyurlcmd } },
	{ LEFTALT,              XK_c,           externalpipe,   {.v = copyoutput } },
};
